...
ui<-
  dashboardPage(
    title = paste0('Thurston County Lakes Water Quality Data Dashboard - BETA (', Sys.Date(),')'),
    dashboardHeader(
    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        menuItem(text = 'Summary of Trophic State Index',
                 tabName = 'sum_tsi',
                 icon = icon("tint", lib = "glyphicon")),
        menuItem(text = 'Summary of Water Quality Trends ',
                 tabName = "trends",
                 icon = icon("tint", lib = "glyphicon")),
        menuItem(text = 'Lake Trophic State Index',
                 tabName = "tsi",
                 icon = icon("tint", lib = "glyphicon")),
    ...
    tabItems(
      ...
      tabItem(tabName='sum_tsi',
               ...
               fluidRow(column(8,leafletOutput('tsi_map',height=800,width="100%")),
                        column(4,
                               p(paste('Lakes are commonly classified into three trophic states based on their amount of nutrients and algae (Carlson, 1977).',
